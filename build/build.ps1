...
Copy-Item .\src\Foundation\CSSGridLayout\code\App_Config\Include\CSSGridLayout\Foundation.Sitecore.CSSGridLayout.config .\build\package\App_Config\Include\Foundation
